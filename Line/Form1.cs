...
namespace Line
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            pb_Result_A.Size = new Size(500, 500);
            pb_Result_B.Size = new Size(500, 500);
            //Шрифти
            ...
            if (nud_A.Value == 2)
            {
                pb_Result_A.Visible = true;
                pb_Result_B.Visible = false;
            ...
            if (nud_B.Value == 2)
            {
                pb_Result_A.Visible = false;
                pb_Result_B.Visible = true;
